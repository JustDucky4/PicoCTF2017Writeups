...
First, it's always good to see if the name is a hint. I started by googling for "substitute cipher." The first result I got was [quipqiup](http://quipqiup.com/)
...
```
There was more, but we already have the flag. If you want to find out what the rest of it said, try it yourself. Anyway, the flag is `IFONLYMODERNCRYPTOWASLIKETHIS`
